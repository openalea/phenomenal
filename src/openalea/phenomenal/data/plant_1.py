...
def plant_1_images():
    ...
    data_directory = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/images/')
    ...
    for path in files_path:
        ...
        images[id_camera][angle] = read_image(path, cv2.IMREAD_UNCHANGED)
...
def plant_1_images_chessboard():
    data_directory = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/images_chessboard/')
    ...
    chessboard_images = collections.defaultdict(dict)
    for i in range(len(files_path)):
        chessboard_images['side'][angles[i]] = read_image(
...
def plant_1_images_binarize():
    ...
    data_directory = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/images_binarize/')
...
def plant_1_mask_meanshift():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_mean_shift.png')
...
def plant_1_mask_hsv():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_hsv.png')
...
def plant_1_mask_clean_noise():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_clean_noise.png')
...
def plant_1_mask_adaptive_threshold():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_adaptive_threshold.png')
...
def plant_1_mask_elcom_mean_shift():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_elcom_mean_shift.png')
...
def plant_1_mask_elcom_hsv():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_elcom_hsv.png')
...
def plant_1_mask_hsv_roi_main():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_hsv_roi_main.png')
...
def plant_1_mask_hsv_roi_band():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_hsv_roi_band.png')
...
def plant_1_mask_hsv_roi_pot():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/mask_hsv_roi_pot.png')
...
def plant_1_background_hsv():
    ...
    file_path = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data/plant_1/mask/background_hsv.png')
...
def plant_1_chessboards():
    ...
    data_directory = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data//plant_1/')
...
def plant_1_voxel_grid(voxels_size=10):
    ...
    if 3 <= int(voxels_size) <= 20:
        ...
        return VoxelGrid.read_from_xyz(filename, voxels_size)

    return None


def plant_2_voxel_grid(voxels_size=10):

    data_directory = pkg_resources.resource_filename(
        'openalea.phenomenal', 'data//plant_2/')
