...
openalea_phenomenal_image_side_binarization = Factory(name='side_binarization',
                authors='Me (wralea authors)',
                description='',
                category='openalea.phenomenal.image',
                nodemodule='openalea.phenomenal.image',
...
openalea_phenomenal_image_meanshift_hsv = Factory(name='meanshift_hsv',
                authors='Me (wralea authors)',
                description='',
                category='openalea.phenomenal.image',
                nodemodule='openalea.phenomenal.image',
                nodeclass='meanshift_hsv',
                inputs=None,
                outputs=None,
                widgetmodule=None,
                widgetclass=None,
