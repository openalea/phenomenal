...
#       ========================================================================
#       Local Import
from alinea.phenomenal.calibration_chessboard import \
    Calibration, \
    Chessboard
...
def get_parameters(data_directory):
...
def example_calibration(data_directory, pickle_name):
    images, chessboard = get_parameters(data_directory)
...
def example_compute_rotation_and_translation_vectors(calibration_name):
    ...
    my_calibration.write_calibration('example_calibration_2')
...
if __name__ == "__main__":
    example_calibration('../../local/data/CHESSBOARD/', 'example_calibration_1')
    example_compute_rotation_and_translation_vectors('example_calibration_1')
