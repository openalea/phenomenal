...
Alinea phenomenal documentation
#########################################################################
...
- A `PDF <../latex/phenomenal.pdf>`_ version of |phenomenal| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:phenomenal:phenomenal>`__ wiki.
